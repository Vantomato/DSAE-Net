...
required_named.add_argument('--dataset', type=str, default='DRIVE', help='generate results for which dataset', required=False)
...
parser.add_argument('--config_file', type=str, default='experiments/wnet_drive/config.cfg', help='experiments/name_of_config_file, overrides everything')
