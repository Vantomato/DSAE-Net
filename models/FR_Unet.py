...
class FR_UNet(nn.Module):
    ...
    def __init__(self, num_classes=1, in_channels=1, feature_scale=2, dropout=0.2, fuse=True, out_ave=True):
        ...
        self.block1_3 = block(
            in_channels, filters[0], dp=dropout, is_up=False, is_down=True, fuse=fuse)
        self.block1_2 = block(
...
if __name__ == '__main__':
    ...
    model = FR_UNet(in_channels=3, num_classes=2)
