...
class ULite(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=1):
        ...
        """Encoder"""
        self.conv_in = nn.Conv2d(self.in_channels, 16, kernel_size=7, padding='same')
        ...
        self.conv_out = nn.Conv2d(16, self.n_classes, kernel_size=1)
...
if __name__ == '__main__':
    ...
    model = ULite(in_channels=4, num_classes=2)
